...
export default function Arrow({ type, direction, color, st }) {
    ...
    const arrows = {
        rightArrows: {
            ...
            thin: <svg style={st} width='12' height='26' viewBox='0 0 12 26' fillOpacity='0' xmlns='http://www.w3.org/2000/svg'>
                <path d='M1 0.999999L11 13L0.999999 25' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            </svg>,
        ...
        leftArrows: {
            ...
            thin: <svg style={st} width='12' height='26' viewBox='0 0 12 26' fillOpacity='0' xmlns='http://www.w3.org/2000/svg'>
                <path d='M11 0.999999L0.999999 13L11 25' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            </svg>,
            default: <svg style={st} width='22' height='20' viewBox='0 0 22 20' fill={color} xmlns='http://www.w3.org/2000/svg'>
