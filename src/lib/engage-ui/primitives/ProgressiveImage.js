...
//you can optionally specify width or height or both, but:
// - image never changes its proportions
// - image fully visible (contain fit strategy). Exept animation modes.
// - viewport width has higher priority than "width" property
